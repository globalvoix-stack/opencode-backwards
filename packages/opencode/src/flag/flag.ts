...
export namespace Flag {
  ...
  export declare const OPENCODE_WEB_ROOT: string | undefined
...
// Dynamic getter for OPENCODE_WEB_ROOT
Object.defineProperty(Flag, "OPENCODE_WEB_ROOT", {
  get() {
    return process.env["OPENCODE_WEB_ROOT"]
  },
  enumerable: true,
  configurable: false,
})
